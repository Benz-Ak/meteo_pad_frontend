...
function FeatureCard({ icon, title, description }) {
  return (
    <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 shadow-lg text-center flex flex-col items-center gap-4 hover:scale-[1.03] transition-transform duration-300 cursor-default">
      <div>{icon}</div>
